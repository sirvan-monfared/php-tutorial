            ...
            <div class="category-dropdown me-md-3">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item" id="low" href="javascript:void(0)">کمترین
                                قمت</a>
                        </li>
                        <li>
                            <a class="dropdown-item" id="high" href="javascript:void(0)">بیشترین
                                قیمت</a>
                        </li>
                        <li>
                            <a class="dropdown-item" id="rating"
                               href="javascript:void(0)">امتیاز</a>
                        </li>
                        <li>
                            <a class="dropdown-item" id="aToz" href="javascript:void(0)">به ترتیب
                                حروف الفبا</a>
                        </li>
                        <li>
                            <a class="dropdown-item" id="zToa" href="javascript:void(0)">برعکس حروف
                                الفبا</a>
                        </li>
                        <li>
                            <a class="dropdown-item" id="off" href="javascript:void(0)">بیشترین
                                تخفیف</a>
                        </li>
                    </ul>
                </div>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="fruit">
                            <span class="name">میوه و سبزیجات</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="cake">
                            <span class="name">نانوایی، کیک و لبنیات</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="behe">
                            <span class="name">نوشیدنی ها</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="snacks">
                            <span class="name">تنقلات و غذاهای مارک دار</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="beauty">
                            <span class="name">زیبایی و خانگی</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="pets">
                            <span class="name">آشپزخانه، باغ و حیوانات خانگی</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="egg">
                            <span class="name">تخم مرغ، گوشت و ماهی</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="food">
                            <span class="name">غذاهای لذیذ و جهانی</span>
                            <span class="number">(30)</span>
                        </label>
                    </div>
                </li>
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="care">
                            <span class="name">مراقبت کودک</span>
                            <span class="number">(20)</span>
                        </label>
                    </div>
                </li>
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="fish">
                            <span class="name">ماهی و غذاهای دریایی</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="marinades">
                            <span class="name">مارینادها</span>
                            <span class="number">(05)</span>
                        </label>
                    </div>
                </li>
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="lamb">
                            <span class="name">گوشت گوسفند و بره</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="other">
                            <span class="name">بندر و گوشت های دیگر</span>
                ...
                <li>
                    <div class="form-check ps-0 m-0 category-list-box">
                        ...
                        <label class="form-check-label" for="salami">
                            <span class="name">سوسیس، بیکن و سالامی</span>
