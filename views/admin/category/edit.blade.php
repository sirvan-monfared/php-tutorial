                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.category.update', ['id' => $category->id]) }}" class="theme-form theme-form-2 mega-form">
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="name" id="name" value="{{ $category->name }}" placeholder="نام دسته بندی جدید">
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="slug" id="slug" value="{{ $category->slug }}" placeholder="نام دسته بندی جدید">
