        ...
        <div class="mb-4 row align-items-center">
            ...
            <div class="col-sm-9">
                <select class="js-example-basic-single w-100" name="status" id="status">
                    ...
                    <option value="{{ \App\Models\Order::NOT_PAID }}" @selected($order->status === \App\Models\Order::NOT_PAID)>
                        پرداخت نشده
                    </option>
                    <option value="{{ \App\Models\Order::PAID }}" @selected($order->status === \App\Models\Order::PAID)>
                        پرداخت شده
                    </option>
                    <option value="{{ \App\Models\Order::FAILED }}" @selected($order->status === \App\Models\Order::FAILED)>
                        پرداخت ناموفق
                    </option>
                </select>
